...
import HeaderConcessionOptionalFee from './HeaderConcessionOptionalFee';
import ConcessionOptionalFeesFilterPanel from './ConcessionOptionalFeesFilterPanel';
// ==========================================================================================================

const ConcessionOptionalFees = ({ }) => {
    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <HeaderConcessionOptionalFee
            headerTitle={"Concession & Optional Fees"}
          ...
          <ConcessionOptionalFeesFilterPanel
...
export default ConcessionOptionalFees;
// ================================================================
