          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl w-full max-w-md p-6 transform transition-all duration-300 border border-gray-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="cursor-pointer w-full flex items-center justify-center gap-2 bg-gradient-to-r from-accent to-blue-600 text-white font-semibold py-3 rounded-xl shadow-md hover:shadow-lg hover:scale-[1.02] transition-all"
                >
